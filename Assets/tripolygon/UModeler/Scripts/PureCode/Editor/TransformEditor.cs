...
namespace TPUModelerEditor
{
    ...
    [CanEditMultipleObjects, CustomEditor(typeof(UnityEngine.Transform))]
    public class TransformEditor : Editor
    {
        ...
        public void OnEnable()
        {
            ...
            UpdateInstance((UnityEngine.Transform)target, root: true);
        }

        private void UpdateInstance(UnityEngine.Transform transform, bool root)
        {
            ...
            if (!root || modeler == null)
            {
                ...
                {
                    UnityEngine.Transform childTM = transform.GetChild(i);
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!ValidatePosition(((UnityEngine.Transform)this.target).position))
            {
        ...
        private void RotationPropertyField(GUIContent content)
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                {
                    UnityEngine.Transform t = (UnityEngine.Transform)this.targets[i];
